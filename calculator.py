...
Button(root,text=" 0",command=lambda:get_variable(0)).grid(row=4,column=3)

Button(root,text="<-",command=lambda :undo()).grid(row=1,column=2)
Button(root,text="ac",command=lambda :clear_all()).grid(row=1,column=3)
Button(root,text="%",command=lambda :get_operator('%')).grid(row=1,column=0)
...
Button(root,text=" ) ",command=lambda :get_operator(')')).grid(row=1,column=5)
...
Button(root,text=" = ",command=lambda :equal()).grid(row=4,column=5)
